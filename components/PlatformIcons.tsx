      ...
      {platforms.map(({ Icon, name, delay, offset }) => (
        ...
        >
          ...
          >
            ...
            {/* Icon */}
            <Icon className="text-4xl md:text-5xl text-white opacity-40 group-hover:opacity-100 group-hover:text-white transition-all duration-300 filter group-hover:drop-shadow-[0_0_15px_rgba(22,204,155,0.8)]" />
